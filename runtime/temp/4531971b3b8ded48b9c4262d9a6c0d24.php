<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:80:"C:\wamp64\www\1805\shop\tp5\public/../application/index\view\product\detail.html";i:1539762336;s:72:"C:\wamp64\www\1805\shop\tp5\public/../application/index\view\layout.html";i:1539745259;s:79:"C:\wamp64\www\1805\shop\tp5\public/../application/index\view\public\header.html";i:1539764708;s:79:"C:\wamp64\www\1805\shop\tp5\public/../application/index\view\public\footer.html";i:1539073920;}*/ ?>
    ...
    <div class="content">
        ...
        <div class="pro_des">
            ...
            <div class="des_price" style="height: 100px">
                本店价格：<b>￥<?php echo formatMoney($goods['goods_selfprice']); ?></b><br />
                消费积分：<span><?php echo $goods['goods_score']; ?></span><br />
                库存：<span id="stock" style="display: none"><?php echo $goods['goods_stock']; ?></span>
            </div>
...
$('.n_ipt').blur(function(){
    ...
    $('#cart').click(function(){
        ...
        $.ajax({
            ...
            data:'buy_number='+buy_number+"&goods_id=<?php echo $goods['goods_id']; ?>",
            dataType:'json',
            type:'post',
