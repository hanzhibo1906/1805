<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:83:"C:\wamp64\www\1805\aliyun_1805\public/../application/index\view\product\detail.html";i:1542591265;s:75:"C:\wamp64\www\1805\aliyun_1805\public/../application/index\view\layout.html";i:1539745260;s:82:"C:\wamp64\www\1805\aliyun_1805\public/../application/index\view\public\header.html";i:1539764710;s:82:"C:\wamp64\www\1805\aliyun_1805\public/../application/index\view\public\footer.html";i:1539073922;}*/ ?>
...
<div class="i_bg">
    ...
    <div class="content">
        ...
        <div id="tsShopContainer">
            <div id="tsImgS">
                <a href="__PUBLIC__<?php echo $big['0']; ?>" title="Images" class="MagicZoom" id="MagicZoom">
                    <img src="__PUBLIC__<?php echo $big['0']; ?>" width="390" height="390" />
                </a>
            </div>
            <div id="tsPicContainer">
                ...
                <div id="tsImgSCon">
                    <ul>
                        <?php if(is_array($big) || $big instanceof \think\Collection || $big instanceof \think\Paginator): $i = 0; $__LIST__ = $big;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                        <li onclick="showPic(<?php echo $key; ?>)" rel="MagicZoom" >
                            <img src="__PUBLIC__<?php echo $v; ?>"
                                 tsImgS="__PUBLIC__<?php echo $big[$key];?>" width="79" height="79" />
                        </li>
        ...
        <div class="pro_des">
            ...
            <div class="des_price">
                本店价格：<b>￥<?php echo formatMoney($goods['sku_price']); ?></b><br />
                消费积分：<span><?php echo $goods['goods_score']; ?></span><br />
                <span id="stock" style="display: none"><?php echo $goods['sku_stock']; ?></span>
            </div>
                    ...
                    <ul>
                        <?php if(is_array($v['son']) || $v['son'] instanceof \think\Collection || $v['son'] instanceof \think\Paginator): $i = 0; $__LIST__ = $v['son'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vv): $mod = ($i % 2 );++$i;
                                if( in_array( $key , $check ) ){
                                    echo  '<li  class="checked" value_id='.$key.'>'.$vv.'
    ...
    <div class="content mar_20">
            ...
            <ul>
                ...
                <li>
                    <div class="img"><a href="#">
                        <img src="__PUBLIC__<?php echo $v['goods_goods_img']; ?>" width="185" height="162" /></a>
                    </div>
                    <div class="name"><a href="#"><?php echo $v['goods_name']; ?></a></div>
                    <div class="price">
                        <font>￥<span><?php echo formatMoney($v['goods_selfprice']); ?></span></font> &nbsp;
                    </div>
                </li>
                <?php endforeach; endif; else: echo "" ;endif; ?>
        ...
        <div class="l_list">
            ...
            <div class="des_border">
                ...
                <div class="des_con" id="p_attribute">
                    ...
                    <table border="1"  align="center"
                           style="width:90%; font-family:'宋体'; margin:10px auto;text-align: center"
                        ...
                        <?php if(is_array($basic) || $basic instanceof \think\Collection || $basic instanceof \think\Paginator): $i = 0; $__LIST__ = $basic;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                            <tr>
                                <td><?php echo $v['attr_name']; ?></td><td><?php echo $v['basic_value']; ?></td>
                            </tr>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </table>
                </div>
            ...
            <div class="des_border" id="p_details">
                ...
                <div class="des_con" style="width: 100%">
                    <?php echo str_replace('%__IMG__%' ,config('IMG_PATH') ,  $goods['goods_content']); ?>
...
$('.n_ipt').blur(function(){
    ...
    $('#cart').click(function(){
        ...
        $.ajax({
            url:"<?php echo url('Cart/CartAdd'); ?>",
            data:'buy_number='+buy_number+"&goods_id=<?php echo $goods['sku_id']; ?>",
            dataType:'json',
            type:'post',
    ...
    function checkSku(){
        ...
        $.ajax({
            ...
            success:function( info ){
                if( info.status == 1000 ){
                    var url = "<?php echo url('Product/productDetail' , ['id' => '__sku_id__'] ); ?>";
                    url = url.replace( '__sku_id__' , info.data.sku_id) ;
