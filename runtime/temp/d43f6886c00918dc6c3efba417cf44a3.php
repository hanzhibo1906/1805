<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"C:\wamp64\www\1805\shop\tp5\public/../application/admin\view\Login\loginShow.html";i:1536369511;}*/ ?>
...
<div class="login-aside">
  ...
  <div id="o-box-down"  style="table-layout:fixed;">
   ...
   <div class="fm-item">
	   ...
	   <input type="text" placeholder="输入账号" name="admin_name" lay-verify="required|username" class="i-text">
       <div class="ui-form-explain"></div>
  </div>

  <div class="fm-item">
	   <label for="logonId" class="form-label">登陆密码：</label>
	   <input type="password" value="" maxlength="100" name="admin_pwd" class="i-text" lay-verify="required" placeholder="请设置密码！">
       <div class="ui-form-explain"></div>
  </div>

  <div class="fm-item pos-r">
	   <label for="logonId" class="form-label">验证码</label>
	   <input type="text" placeholder="输入验证码"  lay-verify="required" name="mycode" class="i-text yzm">
