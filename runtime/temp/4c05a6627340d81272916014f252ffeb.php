<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:78:"C:\wamp64\www\1805\shop\tp5\public/../application/index\view\product\list.html";i:1539315254;s:72:"C:\wamp64\www\1805\shop\tp5\public/../application/index\view\layout.html";i:1539745259;s:79:"C:\wamp64\www\1805\shop\tp5\public/../application/index\view\public\header.html";i:1539764708;s:81:"C:\wamp64\www\1805\shop\tp5\public/../application/index\view\product\product.html";i:1539333159;s:79:"C:\wamp64\www\1805\shop\tp5\public/../application/index\view\public\footer.html";i:1539073920;}*/ ?>
...
<div class="menu_bg">
    <div class="menu">
                        ...
                        <div class="zj">
                            <div class="zj_l">
                                ...
                                <div class="zj_l_c">
                                    ...
                                    <a href="<?php echo url('Product/productList',['cid'=>$vvv['cate_id']]); ?>">
                                        <?php echo $vvv['cate_name']; ?>
                                    </a>|
        ...
        <!--End 商品分类详情 End-->
        <ul class="menu_r">
            <li><a href="__STATIC__/index/Index.html">首页</a></li>
            <li><a href="__STATIC__/index/Food.html">美食</a></li>
...
<div class="i_bg">
    <div class="postion">
        <span class="fl">全部 > <?php if($one != []): ?><?php echo $one['cate_name']; endif; ?> >
            <?php if($two != []): ?><?php echo $two['cate_name']; endif; ?> >
            <?php if($three != []): ?><?php echo $three['cate_name']; endif; ?> </span>
        <div class="none">
        ...
        <table border="0" class="choice" style="width:100%; font-family:'宋体'; margin:0 auto;" cellspacing="0" cellpadding="0">
            <tr valign="top">
                ...
                <td class="td_a brand">
                    ...
                    <a href="javascript:;" brand_id="<?php echo $v['brand_id']; ?>"><?php echo $v['brand_name']; ?></a>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </td>
            </tr>
...
<script type="text/javascript">
    ...
    function getAjaxPage( type , order_field , order_type ){
        ...
        if( type == 1 ){
            ...
            $.ajax({
                url:"<?php echo url('product/showMoneySelect',['cid' => request() -> param('cid')] ); ?>",
                data:data,
                type:'post',
                dataType:'json',
        ...
        // ajax请求筛选对应品牌下边的商品
        $.ajax({
            url:"<?php echo url('product/productList',['cid' => request() -> param('cid')] ); ?>",
            data:data,
            type:'post',
            dataType:'json',
            success:function( html_info ){
